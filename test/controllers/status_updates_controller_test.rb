...
class StatusUpdatesControllerTest < ActionController::TestCase
  ...
  test "should create status_update" do
    assert_difference('StatusUpdate.count') do
      post :create, status_update: { blockers: @status_update.blockers, doing: @status_update.doing, done: @status_update.done, user_id: @status_update.user_id }
    end
  ...
  test "should update status_update" do
    patch :update, id: @status_update, status_update: { blockers: @status_update.blockers, doing: @status_update.doing, done: @status_update.done, user_id: @status_update.user_id }
    assert_redirected_to status_update_path(assigns(:status_update))
  end
